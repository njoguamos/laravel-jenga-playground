<x-app-layout>
    <div class="flex flex-col space-y-6 w-full">
        <div class="flex flex-col">
            <h2 class="text-xl font-semibold mb-5 text-gray-700">Payment Gateway</h2>
        ...
        <div class="flex flex-col">
            <h2 class="text-xl font-semibold mb-5 text-gray-700">Forex Rates</h2>
            <a class="bg-white flex px-6 py-4 space-x-2 rounded-lg shadow hover:bg-gray-50 items-center"
               href="{{ route('forex') }}">
                <span class="flex flex-col w-full">
        ...
        <div class="flex flex-col">
            <h2 class="text-xl font-semibold mb-5 text-gray-700">ID Verification</h2>
            <a class="bg-white flex px-6 py-4 space-x-2 rounded-lg shadow hover:bg-gray-50 items-center"
               href="{{ route('identity') }}">
                <span class="flex flex-col w-full">
        ...
        <div class="flex flex-col">
            <h2 class="text-xl font-semibold mb-5 text-gray-700">Account Services</h2>
            <a class="bg-white flex px-6 py-4 space-x-2 rounded-lg shadow hover:bg-gray-50 items-center"
               href="{{ route('account-inquiry') }}">
                <span class="flex flex-col w-full">
                    <h3 class="text-xl font-bold mb-2">Account Inquiry - Bank Accounts</h3>
                    <p class="text-gray-700 text-sm max-w-sm">Account Inquiry - Bank Accounts</p>
                </span>
                <svg class="h-8" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.5"
                     viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" stroke-linecap="round"
